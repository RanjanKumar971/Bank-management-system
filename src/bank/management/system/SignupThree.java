...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno) {
        ...
        ButtonGroup grounpaccount = new ButtonGroup();
        grounpaccount.add(r1);
        grounpaccount.add(r2);
        grounpaccount.add(r3);
        grounpaccount.add(r4);
